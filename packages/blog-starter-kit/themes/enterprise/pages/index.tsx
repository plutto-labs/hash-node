		...
		<AppProvider publication={publication}>
			<Layout>
				...
				<Container className="flex flex-col items-stretch gap-10 px-5 pb-10">
					...
					{allPosts.length > 0 && (
						<div className="bg-indigo-50 grid grid-cols-4 rounded-lg px-5 py-5 dark:bg-neutral-900 md:py-10">
							<div className="col-span-full md:col-span-2 md:col-start-2">
								<h2 className="text-indigo-600 dark:text-indigo-500 mb-5 text-center text-lg font-semibold">
