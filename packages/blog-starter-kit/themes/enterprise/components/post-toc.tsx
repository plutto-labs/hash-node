			...
			{children.map((item) => (
				<li key={item.id}>
					<a
						...
						className="hover:text-indigo-600 hover:bg-indigo-50 dark:hover:text-indigo-500 underline dark:hover:bg-neutral-800"
					>
						{item.title}
					</a>
	...
	return (
		<div className="w-full px-5">
			<div className="mx-auto w-full max-w-screen-md rounded-lg border border-b-4 border-r-4 p-5 text-base leading-snug dark:border-neutral-800 dark:text-neutral-50 md:p-8 md:text-lg">
				<h2 className="mb-5 text-lg font-bold md:text-xl">Tabla de Contenidos</h2>
