			...
			{!status && (
				<div className="relative w-full rounded-full bg-white p-2 dark:bg-neutral-950">
					<input
						...
						className="focus:outline-indigo-600 dark:focus:outline-indigo-500 left-3 top-3 w-full rounded-full p-3 text-base text-black outline-none dark:bg-neutral-950 dark:text-neutral-50"
					/>
					<button
						disabled={requestInProgress}
						onClick={subscribe}
						className="bg-indigo-600 dark:bg-indigo-600 absolute right-3 top-3 rounded-full px-3 py-2 text-white disabled:cursor-not-allowed disabled:opacity-80"
					>
						Suscríbete
					</button>
				</div>
